...
Page({
  ...
  // bindPayImage: function() {
  //   util.rpcWrite(1002, api.EngineerOrder, [this.data.order_list_id], { 'payment_images': this.data.payment_images, 'payment_amount': this.data.payment,'state': '1'}).then(function (res) {
